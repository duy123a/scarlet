...
namespace ScarletWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IEmailSender _emailSender; // this interface doesn't have default implement, so we need to create one .~.
